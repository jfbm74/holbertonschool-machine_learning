...
def create_batch_norm_layer(prev, n, activation):
    """Function that createsnormalization layer for a neural network"""
...
def learning_rate_decay(alpha, decay_rate, global_step, decay_step):
    """Function that creates a learning rate decay using inverse
    time decay"""
...
def shuffle_data(X, Y):
    """Function that the data  two matrices """
